...
public class IabHelper {
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode,
                        final OnIabPurchaseFinishedListener listener, String extraData) {
        checkNotDisposed();
     ...
     */
    // Appc: added this method to still have the same signature as the one below that was changed
